...
class BurgersDAO
{
    ...
    public function getBurgers()
    {
        $sql = "SELECT * 
                ...
                WHERE jack_tblBurgers.isServed = 1
    ...
    public function getBurgerById($id){
        $sql = "SELECT jack_tblBurgers.* , jack_tblUsers.imageURL, jack_tblUsers.sort_id, jack_tblUsers.name, jack_tblLayertypes.name AS ingredient_name
                FROM jack_tblBurgers
